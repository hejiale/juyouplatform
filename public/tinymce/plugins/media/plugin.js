...
;(function() {
  ...
  var showDialog = function(editor) {
    ...
    if (isFirstMedia && !initialData.embed) {
      editor.notificationManager.open({
        text: '只能上传一个视频附件',
        type: 'error'
      })
  ...
  var register$1 = function(editor) {
    editor.ui.registry.addToggleButton('media', {
      ...
      onAction: function(params) {
        let videoNodes = editor.iframeElement.contentWindow.document.querySelectorAll(
          '.mce-object-video'
        )
