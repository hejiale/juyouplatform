    ...
    >
      ...
      <template slot="actions" slot-scope="props">
        ...
        <el-button
          ...
          >编辑</el-button
        >
        <el-button type="text" v-if="$powers('/versionControl/deleteVersionControl')" @click="goDel(props.id)" class="reject">删除</el-button>
      </template>
    </yc-table>
...
import addVersionInfoIOS from './addVersionInfoIOS.vue'
import editVersionInfoIOS from './editVersionInfoIOS.vue'
...
export default {
  ...
  methods: {
    ...
    cancel(flag) {
      this.dialogVisibleEdit = flag
    },
    //新增剧本成功
    onSuccessInsert() {
      this.$refs.addVersionInfoIOS.doSubmit(()=>{
    ...
    //编辑剧本成功
    onSuccessEdit() {
      this.$refs.editVersionInfoIOS.doubmit(()=>{
